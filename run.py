"""One-command launcher for the FIFA World Cup Analytics project.
...
def ensure_python_deps():
    ...
    marker = VENV / ".fifa_requirements_installed"
...
def main():
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("  FIFA WORLD CUP ANALYTICS IS READY")
        print("=" * 60)
        print(f"\n  WEBSITE: {website_url}\n")
        ...
        print("\nStopping FIFA World Cup Analytics...")
    finally:
